...
const ContainerForm = () => {
  ...
  const handleOnSubmit = async (e) => {
    try {
      ...
      router.push(
        `/searchFlight?origin=${searchObj.originLocationCode}&destination=${
                      ...
                      {isDropdownVisible && originAirportList.length > 0 && (
                        <ul
                          ...
                          style={{
                            ...
                            left: "37.5px",
                            width: "338.5px",
                            display: originAirportList.length
                              ? "block"
                              : "none",
                          }}
                        >
