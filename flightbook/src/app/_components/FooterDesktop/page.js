...
<section className="footerLeft">
  <div>
    ...
    <p className="socialMedia">
      ...
      <a href="https://www.facebook.com/redumbrellaholidays" target="_blank">
...
<section className="footerBootom">
  <div>
    <p className="footeraddress">
      RED UMBRELLA HOLIDAYS LLC bearing Registration No. 10843049, is located
      at 448 PRAIRIE KNOLL DR NAPERVILLE, IL 60565.
    </p>
    <div className="termcndintionFootertxt">
      ...
      <p>
        ...
        and <a href="/post-ticketing-fees"> Post Ticketing Fees</a>. See Red
        Umbrella Holidays <a href="/cookies"> Cookie Policy</a>{" "}
      </p>
    </div>
  </div>
  <p>
