const SearchWidget = ()=>{
    return <section className="search-widget">
<div className="container">
  ...
  <div className="widgettab">
    ...
    >
      <form id="formFlightSearchEngine">
        ...
        <div className="widget-form" id="Tp_roundtrip">
          ...
          <input
            ...
            defaultValue="c2512a20-5ba1-4681-8caa-1208779cfb9e"
          />
          <input
            name="MCSector_2"
            type="hidden"
      ...
      {/* New Calander */}
      <div className="calanderoverly" style={{ display: "block" }}>
        <h4 className="g-orange">
        ...
        <div className="seletDate-Wrap">
          ...
          <div
            className="returns__wrap date--active"
            onclick="returnWrapperClick()"
          >
