...
const FlightForm = () => {
  ...
  const [srcClickedSearchFlightToggeled, setSrcClickedSearchFlightToggle] =
    useState(false);
      ...
      <form id="formFlightSearchEngine">
        ...
        <div className="widget-form" id="Tp_roundtrip">
              ...
              >
                <h4 className="g-orange">
                  ...
                  <a
                    href=""
                    className="close-ol"
                    onClick={() => setSrcClickedToggle(false)}
                  >
                    x
                  </a>
                </h4>
              ...
              >
                <h4 className="g-orange">
                  ...
                  <a
                    href=""
                    className="close-ol"
                    onClick={() => setSrcClickedToToggle(false)}
                  >
                    x
                  </a>
                </h4>
          ...
          <div className="f-tabs dte">
            <div
              className={`searchSec Date ${oneWay ? "oneway" : ""}`}
              id="divDepartSecton"
              onClick={() => {
