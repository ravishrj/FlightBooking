    ...
    return <section className="confirmation">
        <div className="container">
            <div className="headings">
                <a className="btn-back" href="javascript:void(0);" onClick={handleGoBack}>
                    Go Back
                </a>
            ...
            <div className="col-sm-4">
                ...
                >
                    ...
                    <div className="priceboxdtl" id="divPriceSummary">
                        ...
                        <ul>
                            <li>1 x Adult(s)</li>
                            <li>{flight.price.currency}{flight.price.base}</li>
                            <li>{flight.price.currency}{flight.price.total}-{flight.price.base}</li>
                            <li>{flight.price.currency}{flight.price.total}</li>
                        </ul>
                        <ul>
                        ...
                        <ul className="totlevlu totalPrice">
                            <li id="spnTotalfareHeading">Total Price {flight.price.currency}</li>
                        ...
                        <ul className="avg-fare" style={{ display: "none" }}>
                            ...
                            <li className="avg-fare avg-fare-value">{flight.price.currency}{flight.price.total}</li>
                        </ul>
