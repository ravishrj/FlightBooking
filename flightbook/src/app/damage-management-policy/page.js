      ...
      <div className="contentWrp damagePolicy">
        <div className="container">
          ...
          <p>
            ...
            you do to the car while renting it, RedUmbrella Holidays has
          ...
          <p>
            ...
            depending on the type of rental protection you purchased. Please
            carefully read our Terms &amp; Conditions for more information.{" "}
          </p>
          <h3>Types of Damage</h3>
          <p>The cost of damages will change based on the type of damage.</p>
          <p>
            <b>"Light Damage"</b> includes any minor harm done to the car as
            well as any misplacement, theft, or harm done to the car's
            accessories, papers, or keys, as appropriate. Any minor dents,
            chips, or scratches to any part of the car are considered light
            damage.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              tyre and windscreen damage, and (ii) a charge for our loss of use
              of the vehicle as a result of its immobilization. The fees will
              include either a Serious Damage Administration Charge or a Tyre or
              Windscreen Damage Administration Charge, depending on the nature
              of the damage.
            </li>
            <li>
              The costs of the Light Damage Administration Charge, Serious
              Damage, Tyre or Windscreen Damage Administration Charges, and
              Engineer's Charge are specified at the time of booking. Please
              carefully read our terms and conditions for more details.
            </li>
          </ul>
