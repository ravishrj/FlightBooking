  ...
  return (
    <div className="contentWrp">
      ...
      <div className="container">
        <p>
          <b>Red Umbrella Holidays</b> values your trust and treats your privacy
          as our topmost priority and we want you to be aware of the ways we
          collect, use, and disclose your information. Our Privacy Policy shares
          the details of the practices related to the information collected by
          us upon your visit to our website. Your access or use to our website
          via mobile or desktop devices, or avail our booking services that you
          access via our Website and/or contact centers.
        </p>
        <p>
          On your visit to our website or when you avail of any of our services,
          you agree to the terms of the Privacy Policy and our{" "}
        ...
        <p>
          ...
          are required to represent that you have the permission or authority to
          do so. With that authority or permit, you are allowing us to further
          use that information according to this Privacy Policy.&nbsp;&nbsp;
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          when you subscribe to our newsletters and promotions; or when you make
          a booking or avail of our services through our website.
        </p>
        <p>
        ...
        <p>
          ...
          information through the social media platforms that include Facebook,
          Instagram, Twitter, and other third parties to the extent the
        ...
        <p>
          ...
          <br />
          • To complete and fulfill the booking request that you made or service
          availed. It includes the payment process or any communication between
          you and our agent about the booking, to provide you with our customer
          service if required. We also use the information on your passport to
          complete your travel bookings. <br />
          ...
          about the Services and changes incorporated to our terms, conditions,
          or our booking policies.
          <br />
          • To send marketing communications of your interest, as per the
          applicable law.
          <br />
          • To deliver a personalized experience on the Services and tailor-made
          offers for you.
          <br />
          ...
          marketing by identifying your online usage trends. This way we further
          enhance our campaigns.&nbsp;
          <br />
        </p>
        <p>
        ...
        <p>
          ...
          control, and the Personal Information that we disclose to them is, and
          its usage is under their security practices. So you must review their
          privacy policy as well.&nbsp;
          <br />
          • Our parent company, subsidiaries, our joint ventures: Our companies
          are directly under the common control of Red Umbrella Holidays and
          follow the same Policy. Your Personal Information is jointly used by
          ...
          <br />• Your social media accounts have the settings on which you can
          decide whether we can share your information present there in
          connection with your social activity. If you disable it, we won't
          share your Personal Information or you have the choice to not connect
          your social media account with Red Umbrella Holidays.
        </p>
        <p>
        ...
        <p>
          ...
          revealing your identity or relate you to anyone. This includes: <br />
          • Your browser information
          <br />
          • Your device information
          <br />
          • The information collected through cookies, pixel tags, and analytics
          technologies
          <br />
        ...
        <p>
          ...
          collect information like the browser type, time spent on a particular
          webpage on the Red Umbrella Holiday's website, pages visited, language
          preference, and other anonymous traffic data.&nbsp;
        </p>
        <p>
          ...
          includes compiling the statistics about usage and the response rate of
          the customer.
        </p>
        <p>
          ...
          the usage levels, diagnose server issues, and administer the Services.
          This also provides your approximate location.
        </p>
        <p>
        ...
        <p>
          <b>From you:</b>&nbsp;We seek your information regarding the preferred
          means of communication and any special travel requests (example:
          dietary restriction or health concerns.) You provide this information
          to us voluntarily and choose to not share the same with us.
        </p>
        <p>
          <strong>&nbsp;THIRD-PARTY SERVICES</strong>
          <br />
          • Under this Privacy policy, we do not address the practices followed
          by third parties that are linked to us or our website. It includes
          Facebook likes or share buttons. Any links on Red Umbrella Holidays do
          not imply any sort of endorsements.&nbsp;
        ...
        <p>
          We are a travel agency and we use third-party advertising companies to
          serve our advertisements. These advertisements are delivered to you
          depending on your access and use of the devices. For this, third-party
          companies may place cookies in your browser and recognize your devices
          like a mobile or a laptop. To know more, please visit,
          <a
            rel="nofollow"
        ...
        <p>
          ...
          <br />
          Under security, we seek measures to protect Personal Information under
          our technical, organizational, and administrative organization.
          However, unfortunately, no data transmission or storage system is
          known to be 100% secure. So, if you have any reason to believe that
          your interaction with us is not safe or we have breached your privacy,
        ...
        <p>
          ...
          <br />
          As a customer of Red Umbrella Holidays, you are free to choose the way
          to use your Personal Information. You can opt-out from receiving our
          marketing interactions by calling us at{" "}
          <a className="call-phone-number" href="tel:1-833-914-2482">
            1-833-914-2482
          </a>{" "}
        ...
        <p>
          ...
          <br />
          Your Personal Information is retained with us till necessary. We keep
          it to fulfill the purpose as outlined under this Policy. Under some
          circumstances, a longer retention period may be required like
