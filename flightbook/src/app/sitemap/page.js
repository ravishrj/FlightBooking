...
const SiteMap = () => {
  ...
  useEffect(() => {
    ...
    sitemap.rel = "stylesheet";
    sitemap.href = "/Content/css/sitemap.css";

    const sitemapmobile = document.createElement("link");
    sitemapmobile.rel = "stylesheet";
    sitemapmobile.href = "/Content/css/sitemapmobile.css";
    ...
    if (!isMobile) {
      ...
      // document.head.appendChild(mobileCss);
      // document.head.appendChild(mobileHomeCss);
      document.head.appendChild(sitemapmobile);
      //document.head.appendChild(listnav);
        ...
        <section className="sitemap-content">
          <div className="container">
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  href="/book-flights/buenos-aires-bue"
                >
                  Buenos Aires
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/christchurch-chc"
                >
                  Christchurch
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/denpasar-bali-dps"
                >
                  Denpasar Bali
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/indianapolis-ind"
                >
                  Indianapolis
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/johannesburg-jnb"
                >
                  Johannesburg
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/kota-kinabalu-bki"
                >
                  Kota Kinabalu
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/kuala-lumpur-kul"
                >
                  Kuala Lumpur
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/philadelphia-phl"
                >
                  Philadelphia
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/san-francisco-sfo"
                >
                  San Francisco
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/st-petersburg-led"
                >
                  St Petersburg
                </a>
              </li>
              ...
              <li>
                <a
                  className="footer-link"
                  href="/book-flights/united-kingdom-uk"
                >
                  United Kingdom
                </a>
              </li>
            ...
            <ul>
              ...
              <li>
                <a href="/damage-management-policy">
                  {" "}
