...
{
  return <section className="sitemap-content">
  <div className="container">
    ...
    <ul>
      ...
      <li>
        <a className="footer-link" href="/book-flights/fort-lauderdale-fll">
          Fort Lauderdale
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/ho-chi-minh-city-sgn">
          Ho Chi Minh City
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/palma-de-mallorca-pmi">
          Palma De Mallorca
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/puerto-vallarta-pvr">
          Puerto Vallarta
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/raleigh-durham-rdu">
          Raleigh Durham
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/rio-de-janeiro-rio">
          Rio De Janeiro
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/salt-lake-city-slc">
          Salt Lake City
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/sharm-el-sheikh-ssh">
          Sharm El Sheikh
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/southwest-region-flight">
          Southwest Region
        </a>
      </li>
      <li>
      ...
      <li>
        <a className="footer-link" href="/book-flights/west-palm-beach-pbi">
          West Palm Beach
        </a>
      </li>
      <li>
        <a className="footer-link" href="/book-flights/westchester-county-hpn">
          Westchester County
        </a>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        <a href="/flights-reservation/business-class-flights">Business Class</a>
      </li>
      <li>
      ...
      <li>
        <a href="/flights-reservation/student-flights">Students Discount</a>
      </li>
      <li>
        <a href="/flights-reservation/military-flights">Military Discount</a>
      </li>
      <li>
      ...
      <li>
        <a href="/flights-reservation/round-trip-flights">Round Trip Flights</a>
      </li>
      <li>
        <a href="/flights-reservation/domestic-flights">Domestic Flights</a>
      </li>
      <li>
